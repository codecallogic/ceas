...
const componentSort = ['longDescription', 'shortDescription', 'active', 'leader', 'name', 'icon', 'image']
...
const slideSort = ['component', 'title', 'caption', 'image']
const labSort = ['description', 'labLocation','name', 'faculty', 'image', 'icon']
